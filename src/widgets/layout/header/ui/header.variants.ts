...
export const headerVariants = tv({
  slots: {
    header: 'bg-white/90 backdrop-blur-md border-b border-primary-200/60 shadow-lg shadow-primary-900/5 flex justify-center items-center',
    ...
    logoText: 'text-2xl font-bold bg-gradient-to-r from-primary-600 to-primary-800 bg-clip-text text-transparent',
