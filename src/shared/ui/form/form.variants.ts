...
export const formVariants = tv({
  slots: {
    container: 'w-[480px] bg-white/95 backdrop-blur-sm rounded-3xl shadow-2xl shadow-primary-900/10 p-10 border border-primary-100/50',
    title: 'text-4xl font-bold bg-gradient-to-r from-primary-700 to-primary-900 bg-clip-text text-transparent mb-2',
