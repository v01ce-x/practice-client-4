...
export const inputVariants = tv({
  slots: {
    ...
    input: 'w-full px-5 py-3.5 rounded-xl border-2 border-surface-300 bg-white text-surface-900 placeholder:text-surface-400 transition-all duration-300 focus:outline-none focus:border-primary-500 focus:ring-4 focus:ring-primary-100/60 focus:shadow-lg focus:shadow-primary-100/50 disabled:bg-surface-100 disabled:cursor-not-allowed hover:border-surface-400',
